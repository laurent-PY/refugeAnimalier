    ...
    <div class="card shadow bg-white rounded">
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($sante as $santes): ?>
                <td><?= $santes['idSante']?></td>
                <td><?= $santes['etatSante'] ?></td>
                <form action="" method="POST">
                    <td><input type="submit" class="btn btn-danger" name="delete" value="Supprimer"></td> </td>
                    <input type="hidden" class="btn btn-danger" name="delSante" value="<?php echo $santes['idSante'] ?>">
<!--                    <body onclick="alert('Etes-vous certain de vouloir supprimer cette entrée ?')">
-->                </form>
                </tr>
            <?php endforeach ?>
            </tbody>
